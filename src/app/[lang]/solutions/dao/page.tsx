            ...
            <div className="section-content hero-content">
               <div className="row hide-on-med-and-down show-on-large">
                  <div className="col l7">
                     <h1 className="text-white right-align h1-large mt10 mb10">{dict.dao.title}</h1>
                  </div>
                  <div className="col l3 pt10">
                     <blockquote className="pb0 mt10 mb10">
                        <p className="text-white left-align">{dict.dao.subtitle}</p>
                     </blockquote>
                  </div>
               </div>
         ...
         {/* <div className="main-content"> */}
            ...
            <div id="section2" className="section bg-secondary-alt scrollspy-secondary-nav icon-family">
               <div className="section-content section-content-tall">
                  <div className="section-content-left-text">
                     <h2 className="text-white">{dict.dao.whyus}</h2>
                     <div className="csc-thumbnail-container-dbs clients-thumbnail-container">
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           ...
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.dao.dualFramework}</span><br/>{dict.dao.dualFrameworkDesc}</p>
                        ...
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           ...
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.dao.programmableRules}</span><br/>{dict.dao.programmableRulesDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.dao.multiAssetManagement}</span><br/>{dict.dao.multiAssetManagementDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.dao.privacyTransparency}</span><br/>{dict.dao.privacyTransparencyDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.dao.crossGenerational}</span><br/>{dict.dao.crossGenerationalDesc}</p>
                           </div>
                        </div>
                        {/* <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
            ...
            <div id="section3" className="section bg-white scrollspy-secondary-nav">
               <div className="section-content section-content-tall pb10 pt10">
                  <div className="section-content">
                     <h2 className="text-secondary">{dict.dao.moduleTwoTitle}</h2>
                     ...
                     <div className="row partner-table-row display-flex f-wrap">
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              ...
                              <p className="text-secondary pb0 pl30 pt10">{dict.dao.educationMilestoneFund}<br/><br/>{dict.dao.educationMilestoneFundDesc}<br/>{dict.dao.educationMilestoneFundSetting}</p>
                           </div>
                        </div>
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              <span className="text-secondary center-align csc-icon c-i-lock-key-fill"></span>
                              <p className="text-secondary pb0 pl30 pt10">{dict.dao.longTermLivingExpense}<br/><br/>{dict.dao.longTermLivingExpenseDesc}<br/>{dict.dao.longTermLivingExpenseSetting}</p>
                           </div>
                        </div>
                     </div>
                     <div className="row partner-table-row display-flex f-wrap">
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              ...
                              <p className="text-secondary pb0 pl30 pt10">{dict.dao.enterpriseEquityInheritance}<br/><br/>{dict.dao.enterpriseEquityInheritanceDesc}<br/>{dict.dao.enterpriseEquityInheritanceSetting}</p>
                           </div>
                        </div>
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              <span className="text-secondary center-align csc-icon c-i-info"></span>
                              <p className="text-secondary pb0 pl30 pt10">{dict.dao.riskProtectionAssetIsolation}<br/><br/>{dict.dao.riskProtectionAssetIsolationDesc}<br/>{dict.dao.riskProtectionAssetIsolationSetting}</p>
                           </div>
                        </div>
                     </div>
                  </div>
...
<br/>
  ...
  <div>
     Question2: {dict.dao.q2}<br/>
    Answer2: {dict.dao.a2}
  </div>
<br/>
  <div >
    Question3: {dict.dao.q3}<br/>
    Answer3: {dict.dao.a3}
  </div>
<br/>

  <div >
    Question4: {dict.dao.q4}<br/>
    Answer4: {dict.dao.a4}
  </div>
<br/>

  <div>
    Question5: {dict.dao.q5}<br/>
    Answer5: {dict.dao.a5}
  </div>
