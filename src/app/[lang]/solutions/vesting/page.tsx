            ...
            <div className="section-content hero-content">
               <div className="row hide-on-med-and-down show-on-large">
                  <div className="col l7">
                     <h1 className="text-white right-align h1-large mt10 mb10">{dict.vesting.title}</h1>
                  </div>
                  <div className="col l3 pt10">
                     <blockquote className="pb0 mt10 mb10">
                        <p className="text-white left-align">{dict.vesting.subtitle}</p>
                     </blockquote>
                  </div>
               </div>
         ...
         {/* <div className="main-content"> */}
            ...
            <div id="section2" className="section bg-secondary-alt scrollspy-secondary-nav icon-family">
               <div className="section-content section-content-tall">
                  <div className="section-content-left-text">
                     <h2 className="text-white">{dict.vesting.whyus}</h2>
                     <div className="csc-thumbnail-container-dbs clients-thumbnail-container">
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           ...
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.vesting.dualFramework}</span><br/>{dict.vesting.dualFrameworkDesc}</p>
                        ...
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           ...
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.vesting.programmableRules}</span><br/>{dict.vesting.programmableRulesDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.vesting.multiAssetManagement}</span><br/>{dict.vesting.multiAssetManagementDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.vesting.privacyTransparency}</span><br/>{dict.vesting.privacyTransparencyDesc}</p>
                           </div>
                        </div>
                        <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
                           <div className="thumbnail-item-content">
                              ...
                              <p className="m0 pt10 pb10"><span>{dict.vesting.crossGenerational}</span><br/>{dict.vesting.crossGenerationalDesc}</p>
                           </div>
                        </div>
                        {/* <div className="display-flex f-direction-col f-justify-between zoom-card csc-thumbnail-item-dbs clients-thumbnail-item-m bg-white box-shadow-dark center-align">
                           <div className="card-white-bg"></div>
            ...
            <div id="section3" className="section bg-white scrollspy-secondary-nav">
               <div className="section-content section-content-tall pb10 pt10">
                  <div className="section-content">
                     <h2 className="text-secondary">{dict.vesting.moduleTwoTitle}</h2>
                     ...
                     <div className="row partner-table-row display-flex f-wrap">
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              ...
                              <p className="text-secondary pb0 pl30 pt10">{dict.vesting.educationMilestoneFund}<br/><br/>{dict.vesting.educationMilestoneFundDesc}<br/>{dict.vesting.educationMilestoneFundSetting}</p>
                           </div>
                        </div>
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              <span className="text-secondary center-align csc-icon c-i-lock-key-fill"></span>
                              <p className="text-secondary pb0 pl30 pt10">{dict.vesting.longTermLivingExpense}<br/><br/>{dict.vesting.longTermLivingExpenseDesc}<br/>{dict.vesting.longTermLivingExpenseSetting}</p>
                           </div>
                        </div>
                     </div>
                     <div className="row partner-table-row display-flex f-wrap">
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              ...
                              <p className="text-secondary pb0 pl30 pt10">{dict.vesting.enterpriseEquityInheritance}<br/><br/>{dict.vesting.enterpriseEquityInheritanceDesc}<br/>{dict.vesting.enterpriseEquityInheritanceSetting}</p>
                           </div>
                        </div>
                        <div className="col m6 partner-table-item pl20 pr20">
                           <div className="display-flex f-align-center f-justify-center f-direction-col">
                              <span className="text-secondary center-align csc-icon c-i-info"></span>
                              <p className="text-secondary pb0 pl30 pt10">{dict.vesting.riskProtectionAssetIsolation}<br/><br/>{dict.vesting.riskProtectionAssetIsolationDesc}<br/>{dict.vesting.riskProtectionAssetIsolationSetting}</p>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div id="section4" className="section bg-lt-gray scrollspy-secondary-nav">
               <div className="section-content section-content-tall">
                  <div className="section-content">
                     <h2 className="text-secondary">{dict.vesting.faqTitle}</h2>
                     <div>
    
  <div >
    Question1: {dict.vesting.q1}<br/>
    Answer1: {dict.vesting.a1}
  </div>
<br/>

  <div>
     Question2: {dict.vesting.q2}<br/>
    Answer2: {dict.vesting.a2}
  </div>
<br/>
  <div >
    Question3: {dict.vesting.q3}<br/>
    Answer3: {dict.vesting.a3}
  </div>
<br/>

  <div >
    Question4: {dict.vesting.q4}<br/>
    Answer4: {dict.vesting.a4}
  </div>
<br/>

  <div>
    Question5: {dict.vesting.q5}<br/>
    Answer5: {dict.vesting.a5}
  </div>
